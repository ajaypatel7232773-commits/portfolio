          ...
          >
              ...
              <Card>
                <CardContent className="p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Softwere Developer at Yanolja cloud Solution</p>
                  </div>
                </CardContent>
              </Card>
              <Card>
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" asChild>
                <a href="https://drive.google.com/file/d/1_NnGkFhB-7_vj50ZEOf8E7taibq2Q9r3/view?usp=sharing" target="_blank" download>
